...
int main() {
    ...
    NavigationBuilder()
        ...
        .on_item_toggled([&all_sections](size_t section_index, size_t item_index, bool selected) {
        ...
        .on_custom_command([&all_sections](char key, const tui::NavigationTUI::NavigationState &) {
            if (key == 's') {
